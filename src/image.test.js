...
describe('image', () => {
  ...
  it('getOssLiteImgUrl', async () => {
    ...
    expect(await getOssLiteImgUrl(imgUrl, 25000, 100)).toEqual('https://ghost-wwx.oss-cn-hangzhou.aliyuncs.com/ghost/wechatimg256.jpeg?x-oss-process=image/resize,w_100/quality,Q_90')
