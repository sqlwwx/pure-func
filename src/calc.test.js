...
describe('calc', () => {
  ...
  it('sub', () => {
    ...
    expect(sub(8893568.397103781249, -7.29674059550)).toBe(8893575.693844376749)
  ...
  it('mul', () => {
    ...
    expect(mul(5.2, -3.8461538461538462)).toBe(-20)
  ...
  it('div', () => {
    ...
    expect(div(-20, 5.2)).toBe(-3.8461538461538462)
